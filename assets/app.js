...
function setupTheme() {
  let theme =
    localStorage.getItem("tw-market-theme") || "light";
...
async function flows() {
  const d =
    await J("./data/institutional.json");
...
async function volume() {
  const v =
    await J("./data/volume.json");

  const s =
    await J("./data/screener.json");
