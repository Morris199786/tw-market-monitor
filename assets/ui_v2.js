...
function featureIcon(name) {
  const icons = {
    ...
    flow: `<svg viewBox="0 0 24 24" aria-hidden="true">
      <path d="M4 7h12"></path><path d="m13 4 3 3-3 3"></path>
      <path d="M20 17H8"></path><path d="m11 14-3 3 3 3"></path>
    </svg>`,
    ...
    swap: `<svg viewBox="0 0 24 24" aria-hidden="true">
      <path d="M7 7h12l-3-3"></path><path d="m19 7-3 3"></path>
      <path d="M17 17H5l3 3"></path><path d="m5 17 3-3"></path>
    </svg>`,
    ...
    report: `<svg viewBox="0 0 24 24" aria-hidden="true">
      <path d="M6 3h9l4 4v14H6z"></path><path d="M15 3v5h5"></path>
      <path d="M9 12h7"></path><path d="M9 16h7"></path>
    </svg>`,
    holders: `<svg viewBox="0 0 24 24" aria-hidden="true">
      <circle cx="9" cy="8" r="3"></circle><circle cx="17" cy="9" r="2"></circle>
      <path d="M3 20c0-4 2.5-6 6-6s6 2 6 6"></path><path d="M15 15c3 0 5 1.5 5 5"></path>
    </svg>`,
    revenue: `<svg viewBox="0 0 24 24" aria-hidden="true">
      <path d="M4 19V5"></path><path d="M4 19h16"></path>
      <path d="m7 15 4-4 3 2 5-6"></path><path d="M16 7h3v3"></path>
    </svg>`
  };
...
function reorderNavigation() {
  ...
  if (nav) {
    const heatBtn =
      nav.querySelector('[data-p="heat"]');

    const selfBtn =
      nav.querySelector('[data-p="selfReports"]');
